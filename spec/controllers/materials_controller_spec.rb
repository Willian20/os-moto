  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved material as @material" do
        ...
        post :create, {:material => { "nome" => "invalid value" }}, valid_session
        assigns(:material).should be_a_new(Material)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested material" do
        ...
        Material.any_instance.should_receive(:update_attributes).with({ "nome" => "MyString" })
        put :update, {:id => material.to_param, :material => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the material as @material" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Material.any_instance.stub(:save).and_return(false)
        put :update, {:id => material.to_param, :material => { "nome" => "invalid value" }}, valid_session
        assigns(:material).should eq(material)
      end
